...
public abstract record MultiFaceCard<TFace> : CardCoreObject where TFace : CardFaceObject
{
    /// <summary> An array of Card Face objects, if this card is multifaced. </summary>
    [JsonPropertyName("card_faces")]
    public required IReadOnlyList<CardFaceObject> CardFaces { get; init; }
}
public sealed record NormalCard : CardCoreObject;
public sealed record SplitCard : MultiFaceCard<CardFaceObject>;
public sealed record FlipCard : MultiFaceCard<CardFaceObject>;
public sealed record TransformCard : MultiFaceCard<CardFaceDoubleSided>;
public sealed record ModalDfcCard : MultiFaceCard<CardFaceDoubleSided>;
public sealed record MeldCard : CardCoreObject;
public sealed record LevelerCard : CardCoreObject;
public sealed record ClassCard : CardCoreObject;
public sealed record CaseCard : CardCoreObject;
public sealed record SagaCard : CardCoreObject;
public sealed record AdventureCard : MultiFaceCard<CardFaceObject>;
public sealed record PrepareCard : MultiFaceCard<CardFaceObject>;
public sealed record MutateCard : CardCoreObject;
public sealed record PrototypeCard : CardCoreObject;
public sealed record BattleCard : CardCoreObject;
public sealed record PlanarCard : CardCoreObject;
public sealed record SchemeCard : CardCoreObject;
public sealed record VanguardCard : CardCoreObject;
public sealed record TokenCard : CardCoreObject;
public sealed record DoubleFacedTokenCard : MultiFaceCard<CardFaceDoubleSided>;
public sealed record EmblemCard : CardCoreObject;
public sealed record AugmentCard : CardCoreObject;
public sealed record HostCard : CardCoreObject;
public sealed record ArtSeriesCard : MultiFaceCard<CardFaceDoubleSided>;
public sealed record ReversibleCard : MultiFaceCard<CardFaceReversible>;
...
/// </summary>
[JsonConverter(typeof(CardObjectConverter))]
public record CardObject : ScryfallObject;

public record CardCoreObject : CardObject
{
    ...
    public IReadOnlyList<RelatedCardObject>? AllParts { get; init; }
    ...
    [JsonConverter(typeof(ImageStatusConverter))]
