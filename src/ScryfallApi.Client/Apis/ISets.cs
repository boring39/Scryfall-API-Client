...
public interface ISets
{
    ...
    /// </summary>
    /// <returns></returns>
    Task<ResultList<SetObject>> Get(CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    Task<SetObject> Get(string setCode, CancellationToken cancellationToken = default);
}
