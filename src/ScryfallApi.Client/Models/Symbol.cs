...
public record CardSymbol : BaseObject, IEquatable<string>, IComparable, IComparable<string>
{
    ...
    public int CompareTo(string? other) => Symbol.CompareTo(other);
    public int CompareTo(object? other) => CompareTo((other as CardSymbol)?.Symbol);
    public bool Equals(string? other) => Symbol.Equals(other);
